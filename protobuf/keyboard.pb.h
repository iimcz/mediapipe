...
enum KeyActionType : int {
  KEY_UP = 0,
  KEY_DOWN = 1,
  KeyActionType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  KeyActionType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class KeyboardUpdateData final :
 ...
 public:
  ...
  ~KeyboardUpdateData() override;
  explicit PROTOBUF_CONSTEXPR KeyboardUpdateData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  KeyboardUpdateData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const KeyboardUpdateData& from) {
    KeyboardUpdateData::MergeImpl(*this, from);
  }
  private:
...
inline ::naki3d::common::protocol::KeyActionType KeyboardUpdateData::_internal_type() const {
  return static_cast< ::naki3d::common::protocol::KeyActionType >(_impl_.type_);
}
...
inline int32_t KeyboardUpdateData::_internal_keycode() const {
  return _impl_.keycode_;
}
inline int32_t KeyboardUpdateData::keycode() const {
  // @@protoc_insertion_point(field_get:naki3d.common.protocol.KeyboardUpdateData.keycode)
  return _internal_keycode();
}
inline void KeyboardUpdateData::_internal_set_keycode(int32_t value) {
  
  _impl_.keycode_ = value;
}
inline void KeyboardUpdateData::set_keycode(int32_t value) {
