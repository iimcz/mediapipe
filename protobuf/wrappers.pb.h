...
class ServerMessage final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::EncryptionInfo* release_encryption_info();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::LoadPackage* release_load_package();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::ClearPackage* release_clear_package();
...
class DeviceMessage final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::DeviceDescriptor* release_device_descriptor();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::Ping* release_ping();
...
class SensorMessage final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::MediapipeHandTrackingData* release_handtracking();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::GestureData* release_gesture();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::HandMovementData* release_hand_movement();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::BestUserChangedData* release_best_user_changed();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::KeyboardUpdateData* release_keyboard_update();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::MouseMoveData* release_mouse_move();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::MouseButtonData* release_mouse_button();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::MouseScrollData* release_mouse_scroll();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::UltrasonicDistanceData* release_ultrasonic_distance();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::LightLevelData* release_light_level();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::EventData* release_event();
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::PirMovementData* release_pir_movement();
...
class SensorControlMessage final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR SensorControlMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const SensorControlMessage& from) {
    SensorControlMessage::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  PROTOBUF_NODISCARD ::naki3d::common::protocol::SensorListRequest* release_sensor_list();
...
void ServerMessage::set_connection_id(ArgT0&& arg0, ArgT... args) {
...
inline void ServerMessage::set_has_encryption_info() {
  _impl_._oneof_case_[0] = kEncryptionInfo;
}
inline ::naki3d::common::protocol::EncryptionInfo* ServerMessage::release_encryption_info() {
  ...
  if (_internal_has_encryption_info()) {
    clear_has_message();
    ::naki3d::common::protocol::EncryptionInfo* temp = _impl_.message_.encryption_info_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.message_.encryption_info_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::EncryptionInfo* ServerMessage::_internal_mutable_encryption_info() {
  if (!_internal_has_encryption_info()) {
    clear_message();
    set_has_encryption_info();
    _impl_.message_.encryption_info_ = CreateMaybeMessage< ::naki3d::common::protocol::EncryptionInfo >(GetArenaForAllocation());
  }
  return _impl_.message_.encryption_info_;
}
inline ::naki3d::common::protocol::EncryptionInfo* ServerMessage::mutable_encryption_info() {
  ::naki3d::common::protocol::EncryptionInfo* _msg = _internal_mutable_encryption_info();
...
inline void ServerMessage::set_has_load_package() {
  _impl_._oneof_case_[0] = kLoadPackage;
}
inline ::naki3d::common::protocol::LoadPackage* ServerMessage::release_load_package() {
  ...
  if (_internal_has_load_package()) {
    clear_has_message();
    ::naki3d::common::protocol::LoadPackage* temp = _impl_.message_.load_package_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.message_.load_package_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::LoadPackage* ServerMessage::_internal_mutable_load_package() {
  if (!_internal_has_load_package()) {
    clear_message();
    set_has_load_package();
    _impl_.message_.load_package_ = CreateMaybeMessage< ::naki3d::common::protocol::LoadPackage >(GetArenaForAllocation());
  }
  return _impl_.message_.load_package_;
}
inline ::naki3d::common::protocol::LoadPackage* ServerMessage::mutable_load_package() {
  ::naki3d::common::protocol::LoadPackage* _msg = _internal_mutable_load_package();
...
inline void ServerMessage::set_has_clear_package() {
  _impl_._oneof_case_[0] = kClearPackage;
}
inline ::naki3d::common::protocol::ClearPackage* ServerMessage::release_clear_package() {
  ...
  if (_internal_has_clear_package()) {
    clear_has_message();
    ::naki3d::common::protocol::ClearPackage* temp = _impl_.message_.clear_package_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.message_.clear_package_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::ClearPackage* ServerMessage::_internal_mutable_clear_package() {
  if (!_internal_has_clear_package()) {
    clear_message();
    set_has_clear_package();
    _impl_.message_.clear_package_ = CreateMaybeMessage< ::naki3d::common::protocol::ClearPackage >(GetArenaForAllocation());
  }
  return _impl_.message_.clear_package_;
}
inline ::naki3d::common::protocol::ClearPackage* ServerMessage::mutable_clear_package() {
  ::naki3d::common::protocol::ClearPackage* _msg = _internal_mutable_clear_package();
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DeviceMessage::set_connection_id(ArgT0&& arg0, ArgT... args) {
...
inline void DeviceMessage::set_has_device_descriptor() {
  _impl_._oneof_case_[0] = kDeviceDescriptor;
}
inline ::naki3d::common::protocol::DeviceDescriptor* DeviceMessage::release_device_descriptor() {
  ...
  if (_internal_has_device_descriptor()) {
    clear_has_message();
    ::naki3d::common::protocol::DeviceDescriptor* temp = _impl_.message_.device_descriptor_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.message_.device_descriptor_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::DeviceDescriptor* DeviceMessage::_internal_mutable_device_descriptor() {
  if (!_internal_has_device_descriptor()) {
    clear_message();
    set_has_device_descriptor();
    _impl_.message_.device_descriptor_ = CreateMaybeMessage< ::naki3d::common::protocol::DeviceDescriptor >(GetArenaForAllocation());
  }
  return _impl_.message_.device_descriptor_;
}
inline ::naki3d::common::protocol::DeviceDescriptor* DeviceMessage::mutable_device_descriptor() {
  ::naki3d::common::protocol::DeviceDescriptor* _msg = _internal_mutable_device_descriptor();
...
inline ::naki3d::common::protocol::Ping* DeviceMessage::release_ping() {
  ...
  if (_internal_has_ping()) {
    clear_has_message();
    ::naki3d::common::protocol::Ping* temp = _impl_.message_.ping_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::naki3d::common::protocol::Ping* DeviceMessage::_internal_mutable_ping() {
  if (!_internal_has_ping()) {
    clear_message();
    set_has_ping();
    _impl_.message_.ping_ = CreateMaybeMessage< ::naki3d::common::protocol::Ping >(GetArenaForAllocation());
  }
  return _impl_.message_.ping_;
}
inline ::naki3d::common::protocol::Ping* DeviceMessage::mutable_ping() {
  ::naki3d::common::protocol::Ping* _msg = _internal_mutable_ping();
...
inline DeviceMessage::MessageCase DeviceMessage::message_case() const {
  return DeviceMessage::MessageCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SensorMessage::set_sensor_id(ArgT0&& arg0, ArgT... args) {
...
inline uint64_t SensorMessage::_internal_timestamp() const {
  return _impl_.timestamp_;
}
inline uint64_t SensorMessage::timestamp() const {
  // @@protoc_insertion_point(field_get:naki3d.common.protocol.SensorMessage.timestamp)
  return _internal_timestamp();
}
inline void SensorMessage::_internal_set_timestamp(uint64_t value) {
  
  _impl_.timestamp_ = value;
}
inline void SensorMessage::set_timestamp(uint64_t value) {
...
inline void SensorMessage::set_has_handtracking() {
  _impl_._oneof_case_[0] = kHandTracking;
}
inline ::naki3d::common::protocol::MediapipeHandTrackingData* SensorMessage::release_handtracking() {
  ...
  if (_internal_has_handtracking()) {
    clear_has_data();
    ::naki3d::common::protocol::MediapipeHandTrackingData* temp = _impl_.data_.handtracking_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.handtracking_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::MediapipeHandTrackingData* SensorMessage::_internal_mutable_handtracking() {
  if (!_internal_has_handtracking()) {
    clear_data();
    set_has_handtracking();
    _impl_.data_.handtracking_ = CreateMaybeMessage< ::naki3d::common::protocol::MediapipeHandTrackingData >(GetArenaForAllocation());
  }
  return _impl_.data_.handtracking_;
}
inline ::naki3d::common::protocol::MediapipeHandTrackingData* SensorMessage::mutable_handtracking() {
  ::naki3d::common::protocol::MediapipeHandTrackingData* _msg = _internal_mutable_handtracking();
...
inline ::naki3d::common::protocol::GestureData* SensorMessage::release_gesture() {
  ...
  if (_internal_has_gesture()) {
    clear_has_data();
    ::naki3d::common::protocol::GestureData* temp = _impl_.data_.gesture_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.gesture_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::GestureData* SensorMessage::_internal_mutable_gesture() {
  if (!_internal_has_gesture()) {
    clear_data();
    set_has_gesture();
    _impl_.data_.gesture_ = CreateMaybeMessage< ::naki3d::common::protocol::GestureData >(GetArenaForAllocation());
  }
  return _impl_.data_.gesture_;
}
inline ::naki3d::common::protocol::GestureData* SensorMessage::mutable_gesture() {
  ::naki3d::common::protocol::GestureData* _msg = _internal_mutable_gesture();
...
inline void SensorMessage::set_has_hand_movement() {
  _impl_._oneof_case_[0] = kHandMovement;
}
inline ::naki3d::common::protocol::HandMovementData* SensorMessage::release_hand_movement() {
  ...
  if (_internal_has_hand_movement()) {
    clear_has_data();
    ::naki3d::common::protocol::HandMovementData* temp = _impl_.data_.hand_movement_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.hand_movement_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::HandMovementData* SensorMessage::_internal_mutable_hand_movement() {
  if (!_internal_has_hand_movement()) {
    clear_data();
    set_has_hand_movement();
    _impl_.data_.hand_movement_ = CreateMaybeMessage< ::naki3d::common::protocol::HandMovementData >(GetArenaForAllocation());
  }
  return _impl_.data_.hand_movement_;
}
inline ::naki3d::common::protocol::HandMovementData* SensorMessage::mutable_hand_movement() {
  ::naki3d::common::protocol::HandMovementData* _msg = _internal_mutable_hand_movement();
...
inline void SensorMessage::set_has_best_user_changed() {
  _impl_._oneof_case_[0] = kBestUserChanged;
}
inline ::naki3d::common::protocol::BestUserChangedData* SensorMessage::release_best_user_changed() {
  ...
  if (_internal_has_best_user_changed()) {
    clear_has_data();
    ::naki3d::common::protocol::BestUserChangedData* temp = _impl_.data_.best_user_changed_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.best_user_changed_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::BestUserChangedData* SensorMessage::_internal_mutable_best_user_changed() {
  if (!_internal_has_best_user_changed()) {
    clear_data();
    set_has_best_user_changed();
    _impl_.data_.best_user_changed_ = CreateMaybeMessage< ::naki3d::common::protocol::BestUserChangedData >(GetArenaForAllocation());
  }
  return _impl_.data_.best_user_changed_;
}
inline ::naki3d::common::protocol::BestUserChangedData* SensorMessage::mutable_best_user_changed() {
  ::naki3d::common::protocol::BestUserChangedData* _msg = _internal_mutable_best_user_changed();
...
inline void SensorMessage::set_has_keyboard_update() {
  _impl_._oneof_case_[0] = kKeyboardUpdate;
}
inline ::naki3d::common::protocol::KeyboardUpdateData* SensorMessage::release_keyboard_update() {
  ...
  if (_internal_has_keyboard_update()) {
    clear_has_data();
    ::naki3d::common::protocol::KeyboardUpdateData* temp = _impl_.data_.keyboard_update_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.keyboard_update_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::KeyboardUpdateData* SensorMessage::_internal_mutable_keyboard_update() {
  if (!_internal_has_keyboard_update()) {
    clear_data();
    set_has_keyboard_update();
    _impl_.data_.keyboard_update_ = CreateMaybeMessage< ::naki3d::common::protocol::KeyboardUpdateData >(GetArenaForAllocation());
  }
  return _impl_.data_.keyboard_update_;
}
inline ::naki3d::common::protocol::KeyboardUpdateData* SensorMessage::mutable_keyboard_update() {
  ::naki3d::common::protocol::KeyboardUpdateData* _msg = _internal_mutable_keyboard_update();
...
inline ::naki3d::common::protocol::MouseMoveData* SensorMessage::release_mouse_move() {
  ...
  if (_internal_has_mouse_move()) {
    clear_has_data();
    ::naki3d::common::protocol::MouseMoveData* temp = _impl_.data_.mouse_move_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.mouse_move_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::MouseMoveData* SensorMessage::_internal_mutable_mouse_move() {
  if (!_internal_has_mouse_move()) {
    clear_data();
    set_has_mouse_move();
    _impl_.data_.mouse_move_ = CreateMaybeMessage< ::naki3d::common::protocol::MouseMoveData >(GetArenaForAllocation());
  }
  return _impl_.data_.mouse_move_;
}
inline ::naki3d::common::protocol::MouseMoveData* SensorMessage::mutable_mouse_move() {
  ::naki3d::common::protocol::MouseMoveData* _msg = _internal_mutable_mouse_move();
...
inline ::naki3d::common::protocol::MouseButtonData* SensorMessage::release_mouse_button() {
  ...
  if (_internal_has_mouse_button()) {
    clear_has_data();
    ::naki3d::common::protocol::MouseButtonData* temp = _impl_.data_.mouse_button_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.mouse_button_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::MouseButtonData* SensorMessage::_internal_mutable_mouse_button() {
  if (!_internal_has_mouse_button()) {
    clear_data();
    set_has_mouse_button();
    _impl_.data_.mouse_button_ = CreateMaybeMessage< ::naki3d::common::protocol::MouseButtonData >(GetArenaForAllocation());
  }
  return _impl_.data_.mouse_button_;
}
inline ::naki3d::common::protocol::MouseButtonData* SensorMessage::mutable_mouse_button() {
  ::naki3d::common::protocol::MouseButtonData* _msg = _internal_mutable_mouse_button();
...
inline void SensorMessage::set_has_mouse_scroll() {
  _impl_._oneof_case_[0] = kMouseScroll;
}
inline ::naki3d::common::protocol::MouseScrollData* SensorMessage::release_mouse_scroll() {
  ...
  if (_internal_has_mouse_scroll()) {
    clear_has_data();
    ::naki3d::common::protocol::MouseScrollData* temp = _impl_.data_.mouse_scroll_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.mouse_scroll_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::MouseScrollData* SensorMessage::_internal_mutable_mouse_scroll() {
  if (!_internal_has_mouse_scroll()) {
    clear_data();
    set_has_mouse_scroll();
    _impl_.data_.mouse_scroll_ = CreateMaybeMessage< ::naki3d::common::protocol::MouseScrollData >(GetArenaForAllocation());
  }
  return _impl_.data_.mouse_scroll_;
}
inline ::naki3d::common::protocol::MouseScrollData* SensorMessage::mutable_mouse_scroll() {
  ::naki3d::common::protocol::MouseScrollData* _msg = _internal_mutable_mouse_scroll();
...
inline void SensorMessage::set_has_ultrasonic_distance() {
  _impl_._oneof_case_[0] = kUltrasonicDistance;
}
inline ::naki3d::common::protocol::UltrasonicDistanceData* SensorMessage::release_ultrasonic_distance() {
  ...
  if (_internal_has_ultrasonic_distance()) {
    clear_has_data();
    ::naki3d::common::protocol::UltrasonicDistanceData* temp = _impl_.data_.ultrasonic_distance_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.ultrasonic_distance_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::UltrasonicDistanceData* SensorMessage::_internal_mutable_ultrasonic_distance() {
  if (!_internal_has_ultrasonic_distance()) {
    clear_data();
    set_has_ultrasonic_distance();
    _impl_.data_.ultrasonic_distance_ = CreateMaybeMessage< ::naki3d::common::protocol::UltrasonicDistanceData >(GetArenaForAllocation());
  }
  return _impl_.data_.ultrasonic_distance_;
}
inline ::naki3d::common::protocol::UltrasonicDistanceData* SensorMessage::mutable_ultrasonic_distance() {
  ::naki3d::common::protocol::UltrasonicDistanceData* _msg = _internal_mutable_ultrasonic_distance();
...
inline void SensorMessage::set_has_light_level() {
  _impl_._oneof_case_[0] = kLightLevel;
}
inline ::naki3d::common::protocol::LightLevelData* SensorMessage::release_light_level() {
  ...
  if (_internal_has_light_level()) {
    clear_has_data();
    ::naki3d::common::protocol::LightLevelData* temp = _impl_.data_.light_level_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.light_level_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::LightLevelData* SensorMessage::_internal_mutable_light_level() {
  if (!_internal_has_light_level()) {
    clear_data();
    set_has_light_level();
    _impl_.data_.light_level_ = CreateMaybeMessage< ::naki3d::common::protocol::LightLevelData >(GetArenaForAllocation());
  }
  return _impl_.data_.light_level_;
}
inline ::naki3d::common::protocol::LightLevelData* SensorMessage::mutable_light_level() {
  ::naki3d::common::protocol::LightLevelData* _msg = _internal_mutable_light_level();
...
inline ::naki3d::common::protocol::EventData* SensorMessage::release_event() {
  ...
  if (_internal_has_event()) {
    clear_has_data();
    ::naki3d::common::protocol::EventData* temp = _impl_.data_.event_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.event_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::EventData* SensorMessage::_internal_mutable_event() {
  if (!_internal_has_event()) {
    clear_data();
    set_has_event();
    _impl_.data_.event_ = CreateMaybeMessage< ::naki3d::common::protocol::EventData >(GetArenaForAllocation());
  }
  return _impl_.data_.event_;
}
inline ::naki3d::common::protocol::EventData* SensorMessage::mutable_event() {
  ::naki3d::common::protocol::EventData* _msg = _internal_mutable_event();
...
inline void SensorMessage::set_has_pir_movement() {
  _impl_._oneof_case_[0] = kPirMovement;
}
inline ::naki3d::common::protocol::PirMovementData* SensorMessage::release_pir_movement() {
  ...
  if (_internal_has_pir_movement()) {
    clear_has_data();
    ::naki3d::common::protocol::PirMovementData* temp = _impl_.data_.pir_movement_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.data_.pir_movement_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::PirMovementData* SensorMessage::_internal_mutable_pir_movement() {
  if (!_internal_has_pir_movement()) {
    clear_data();
    set_has_pir_movement();
    _impl_.data_.pir_movement_ = CreateMaybeMessage< ::naki3d::common::protocol::PirMovementData >(GetArenaForAllocation());
  }
  return _impl_.data_.pir_movement_;
}
inline ::naki3d::common::protocol::PirMovementData* SensorMessage::mutable_pir_movement() {
  ::naki3d::common::protocol::PirMovementData* _msg = _internal_mutable_pir_movement();
...
inline SensorMessage::DataCase SensorMessage::data_case() const {
  return SensorMessage::DataCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
inline void SensorControlMessage::set_has_sensor_list() {
  _impl_._oneof_case_[0] = kSensorList;
}
inline ::naki3d::common::protocol::SensorListRequest* SensorControlMessage::release_sensor_list() {
  ...
  if (_internal_has_sensor_list()) {
    clear_has_message();
    ::naki3d::common::protocol::SensorListRequest* temp = _impl_.message_.sensor_list_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.message_.sensor_list_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::SensorListRequest* SensorControlMessage::_internal_mutable_sensor_list() {
  if (!_internal_has_sensor_list()) {
    clear_message();
    set_has_sensor_list();
    _impl_.message_.sensor_list_ = CreateMaybeMessage< ::naki3d::common::protocol::SensorListRequest >(GetArenaForAllocation());
  }
  return _impl_.message_.sensor_list_;
}
inline ::naki3d::common::protocol::SensorListRequest* SensorControlMessage::mutable_sensor_list() {
  ::naki3d::common::protocol::SensorListRequest* _msg = _internal_mutable_sensor_list();
...
inline void SensorControlMessage::set_has_cec_message() {
  _impl_._oneof_case_[0] = kCecMessage;
}
inline ::naki3d::common::protocol::CECMessage* SensorControlMessage::release_cec_message() {
  ...
  if (_internal_has_cec_message()) {
    clear_has_message();
    ::naki3d::common::protocol::CECMessage* temp = _impl_.message_.cec_message_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.message_.cec_message_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::naki3d::common::protocol::CECMessage* SensorControlMessage::_internal_mutable_cec_message() {
  if (!_internal_has_cec_message()) {
    clear_message();
    set_has_cec_message();
    _impl_.message_.cec_message_ = CreateMaybeMessage< ::naki3d::common::protocol::CECMessage >(GetArenaForAllocation());
  }
  return _impl_.message_.cec_message_;
}
...
inline SensorControlMessage::MessageCase SensorControlMessage::message_case() const {
  return SensorControlMessage::MessageCase(_impl_._oneof_case_[0]);
}
#ifdef __GNUC__
