...
namespace common {
namespace protocol {
constexpr CECMessage::CECMessage(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : action_(0)
{}
struct CECMessageDefaultTypeInternal {
  constexpr CECMessageDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT CECMessageDefaultTypeInternal _CECMessage_default_instance_;
}  // namespace protocol
}  // namespace common
}  // namespace naki3d
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_cec_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_cec_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_cec_2eproto = nullptr;

const uint32_t TableStruct_cec_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::naki3d::common::protocol::CECMessage)},
};
...
const char descriptor_table_protodef_cec_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\tcec.proto\022\026naki3d.common.protocol\"\?\n\nC"
  "ECMessage\0221\n\006action\030\001 \001(\0162!.naki3d.commo"
  "n.protocol.CECAction*(\n\tCECAction\022\014\n\010POW"
  "ER_ON\020\000\022\r\n\tPOWER_OFF\020\001b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_cec_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cec_2eproto = {
  false, false, 150, descriptor_table_protodef_cec_2eproto, "cec.proto", 
  &descriptor_table_cec_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_cec_2eproto::offsets,
  file_level_metadata_cec_2eproto, file_level_enum_descriptors_cec_2eproto, file_level_service_descriptors_cec_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cec_2eproto_getter() {
  return &descriptor_table_cec_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cec_2eproto(&descriptor_table_cec_2eproto);
namespace naki3d {
namespace common {
namespace protocol {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* CECAction_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_cec_2eproto);
  return file_level_enum_descriptors_cec_2eproto[0];
}
...
void CECMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CECMessage *>(to)->MergeFrom(
      static_cast<const CECMessage &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CECMessage::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_cec_2eproto_getter, &descriptor_table_cec_2eproto_once,
      file_level_metadata_cec_2eproto[0]);
}
